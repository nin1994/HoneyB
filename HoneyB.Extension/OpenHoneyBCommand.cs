...
{
    /// <summary>
    /// Adds an "HoneyB" entry under the View > Other Windows menu.
    /// </summary>
    internal sealed class OpenHoneyBCommand
    {
        ...
        private OpenHoneyBCommand(AsyncPackage package, IMenuCommandService commandService)
        {
            _package = package;
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            new OpenHoneyBCommand(package, commandService);
        }
